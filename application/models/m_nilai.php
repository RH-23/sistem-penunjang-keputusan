...
class m_nilai extends CI_Model {
	...
	function get_rangking()
	{
		/*$query = 	"SELECT
					tb_nilai.id_nilai,
					tb_puskesmas.nama_puskesmas,
					(tb_kriteria_lingkungan.bobot_kriteria_lingkungan * 0.40) + (tb_kriteria_tenagamedis.bobot_kriteria_tenmed * 0.25) + (tb_kriteria_pelayanan.bobot_kriteria_pelayanan * 0.15) + (tb_kriteria_fasilitas.bobot_kriteria_fasilitas * 0.20) AS nilai
					FROM
					tb_nilai
					INNER JOIN tb_puskesmas ON tb_puskesmas.id_puskesmas = tb_nilai.id_puskesmas
					INNER JOIN tb_kriteria_lingkungan ON tb_kriteria_lingkungan.id_kriteria_lingkungan = tb_nilai.id_kriteria_lingkungan
